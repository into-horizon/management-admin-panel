...
import { getProductReviews } from 'src/store/product'
import { CCard, CRow, CCol, CCardImage, CCardBody, CCardTitle, CCardText, CButton,CSpinner } from '@coreui/react'
  ...
  return (
    ...
    <CRow className='justify-content-end'>
      ...
      <CRow className='justify-content-center'>
        {Children.toArray(data.map(review =>
          <CCol xs={12}>
              ...
              <CRow className="g-0">
                ...
                <CCol xs={8}>
                  <CCardBody>
                    ...
                    />
                    <CCardText>
                      <small className="text-medium-emphasis">{new Date(review.created_at).toLocaleDateString()}</small>
                    </CCardText>
                  </CCardBody>
                </CCol>
              </CRow>
      ...
      <Paginator cookieName='reviews' count={count} changeData={getProductReviews} params={params} updateParams={setParams} updateLoading={setLoading} />
    </>
  )
}
