...
import { updateStoreStatusHandler } from '../../store/store'
const ActionModal = (
  data: StoreType & {
  ...
  const submitHandler = (e: FormEvent<HTMLFormElement>) => {
    ...
    data.updateStoreStatusHandler(
      { ...data, status: target.status.value, rejected_reason: target.rejected_reason?.value },
      'pending',
    )
    onClose()
  }
