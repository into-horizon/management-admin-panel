...
const Employees : React.LazyExoticComponent<any> =  lazy(()=> import('./views/employees/Overview'))
const routes : {path: string, exact?: boolean, name: string, component?:React.LazyExoticComponent<any>, role?:string }[] = [
