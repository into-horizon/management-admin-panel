...
export const updateDiscountCodeHandler =
  (payload: DiscountCodeType) => async (dispatch: AppDispatch, state: () => RootState) => {
    try {
...
export const createDiscountCode =
  (payload: Omit<DiscountCodeType, 'active'>) => async (dispatch: AppDispatch) => {
    try {
