...
export const addProductHandler = (payload : ProductType) => async (dispatch : AppDispatch) => {
    try {
...
export const updateProductStatus = (payload: ProductType, type : 'pending' | 'overview' = 'pending') => async (dispatch : AppDispatch, state: ()=> RootState) =>{
    try {
...
export const updateSizeAndQuantity = (payload: ProductType) => async (dispatch : AppDispatch, state:  ()=> RootState) => {
    try {
...
export const updateDiscount = (payload: ProductType) => async (dispatch : AppDispatch, state : ()=> RootState) => {
    try {
...
export const getProductReviews = (payload: ReviewType) => async (dispatch : AppDispatch) =>{
    try {
